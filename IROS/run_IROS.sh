...
python IROSrec_pipeline__argparsed.py \
   --run GC_rec_1ks_2-50keV_smoothed_mask25 \
   ...
   --baseline_irosrec /mnt/dbb8f47e-da06-47bf-8ef5-038092af70f7/Edos_Magnificent_Manor/PhD_AASS/Coding/IROS_Data/Outputs/OutGalacticCentre/galctr_rxte-sax_mask_050_1040x17_2-50keV_1ks_mask25/GC_rec_1ks_2-50keV_mask25/ \
